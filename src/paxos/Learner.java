...
/**
 * Learner is responsible to maintain the state of the server and handles the
 * commits to it
 * 
 */
public class Learner extends KeyValueStore implements Runnable {
  ...
  public String commit(String key, String val, int action) {
    String response = "";
